...
public class VehiculoInvolucradoModel implements Serializable{
	...
	@ApiModelProperty(position = 1, required = true,  example = "123ABC", value = "Placa del vehículo (sin caracteres extra�os o espacios)", name="Placa")
	private String placa;
	
	@ApiModelProperty(position = 2, required = false,  example = "10", value = "Correspondiente a la Marca del veh�culo (Catálogo)", name="id Marca")
	private int idMarca;
	
	@ApiModelProperty(position = 3, required = false,  example = "5", value = "Corresponde a la Submarca (Catalogo)", name="id SubMarca")
	...
	@ApiModelProperty(position = 7, required = false,  example = "16", value = "Corresponde a la Ciudad de origen del veh�culo (Catálogo)", name="id Procedencia")
	...
	@ApiModelProperty(position = 9, required = false,  example = "1", value = "Tipo de lista a la cual pertenecerá el veh�culo* (Catálogo)", name="Tipo de Lista")
